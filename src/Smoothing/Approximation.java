...
public class Approximation {
    ...
    /**
     * Реализует аппроксимацию полинома методом наименьших квадратов (МНК).
     * @param x Массив значений по оси X.
     * @param y Массив соответствующих значений по оси Y.
    ...
    /**
     * Выполняет аппроксимацию обратной матрицы методом наименьших квадратов.(МНК).
     *
     * @param x массив значений переменных x
     * @param y массив значений переменных y
     * @param m степень полинома для аппроксимации
     * @return массив коэффициентов аппроксимации обратной матрицы
     */
